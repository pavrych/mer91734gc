...
RUN	apt-get update && apt-get install -y git wget build-essential pkg-config cmake unzip python python-zmq zlib1g-dev wget libcurl4-openssl-dev automake curl ibjansson-dev autotools-dev libtool 
